...
class QPixmap(QPaintDevice):
    ...
    @typing.overload
    def loadFromData(self, buf: typing.Union[QtCore.QByteArray, bytes, bytearray], format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlag = ...) -> bool: ...
...
class QBitmap(QPixmap):
    ...
    def swap(self, other: "QBitmap") -> None: ...  # type: ignore[override]
...
class QColor(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def isValidColorName(a0: typing.Union[QtCore.QByteArray, bytes, bytearray, str]) -> bool: ...
    @staticmethod
    def fromString(name: typing.Union[QtCore.QByteArray, bytes, bytearray, str]) -> "QColor": ...
...
class QImageReader(PyQt6.sip.simplewrapper):
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, device: QtCore.QIODevice, format: typing.Union[QByteArray, bytes, bytearray] = ...) -> None: ...
    @typing.overload
    def __init__(self, fileName: str, format: typing.Union[QByteArray, bytes, bytearray] = ...) -> None: ...
    @staticmethod
    ...
    def setDevice(self, device: QtCore.QIODevice) -> None: ...
    def format(self) -> QtCore.QByteArray: ...
    def setFormat(self, format: typing.Union[QByteArray, bytes, bytearray]) -> None: ...
...
class QImageWriter(PyQt6.sip.simplewrapper):
    ...
    def supportedSubTypes(self) -> typing.List[QtCore.QByteArray]: ...
    def subType(self) -> QtCore.QByteArray: ...
    def setSubType(self, type: typing.Union[QByteArray, bytes, bytearray]) -> None: ...
    @staticmethod
    def supportedMimeTypes() -> typing.List[QtCore.QByteArray]: ...
...
class QMovie(QtCore.QObject):
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, device: QtCore.QIODevice, format: typing.Union[QByteArray, bytes, bytearray] = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, fileName: str, format: typing.Union[QByteArray, bytes, bytearray] = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QOpenGLContext(QtCore.QObject):
    ...
    def hasExtension(self, extension: typing.Union[QByteArray, bytes, bytearray]) -> bool: ...
    ...
    def getProcAddress(self, procName: typing.Union[QByteArray, bytes, bytearray]) -> PyQt6.sip.voidptr: ...
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def drawConvexPolygon(self, point: QtCore.QPointF, *a1: QtCore.QPointF) -> None: ...
    @typing.overload
    def drawConvexPolygon(self, points: PyQt6.sip.array[QtCore.QPoint]) -> None: ...
    @typing.overload
    def drawConvexPolygon(self, point: QtCore.QPoint, *a1: QtCore.QPoint) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPolygon(self, point: QtCore.QPointF, *a1: QtCore.QPointF) -> None: ...
    @typing.overload
    def drawPolygon(self, points: PyQt6.sip.array[QtCore.QPoint], fillRule: QtCore.Qt.FillRule = ...) -> None: ...
    @typing.overload
    def drawPolygon(self, point: QtCore.QPoint, *a1: QtCore.QPoint) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPolyline(self, point: QtCore.QPointF, *a1: QtCore.QPointF) -> None: ...
    @typing.overload
    def drawPolyline(self, points: PyQt6.sip.array[QtCore.QPoint]) -> None: ...
    @typing.overload
    def drawPolyline(self, point: QtCore.QPoint, *a1: QtCore.QPoint) -> None: ...
    @typing.overload
    def drawEllipse(self, r: QtCore.QRectF) -> None: ...
    @typing.overload
    def drawEllipse(self, r: QtCore.QRect) -> None: ...
    ...
    def drawRects(self, rects: PyQt6.sip.array[QtCore.QRectF]) -> None: ...
    @typing.overload
    def drawRects(self, rect: QtCore.QRectF, *a1: QtCore.QRectF) -> None: ...
    @typing.overload
    def drawRects(self, rects: PyQt6.sip.array[QtCore.QRect]) -> None: ...
    @typing.overload
    def drawRects(self, rect: QtCore.QRect, *a1: QtCore.QRect) -> None: ...
    @typing.overload
    def drawLines(self, lines: PyQt6.sip.array[QtCore.QLineF]) -> None: ...
    @typing.overload
    def drawLines(self, line: QtCore.QLineF, *a1: QtCore.QLineF) -> None: ...
    @typing.overload
    def drawLines(self, pointPairs: PyQt6.sip.array[QtCore.QPointF]) -> None: ...
    @typing.overload
    def drawLines(self, pointPair: QtCore.QPointF, *a1: QtCore.QPointF) -> None: ...
    @typing.overload
    def drawLines(self, lines: PyQt6.sip.array[QtCore.QLine]) -> None: ...
    @typing.overload
    def drawLines(self, line: QtCore.QLine, *a1: QtCore.QLine) -> None: ...
    @typing.overload
    def drawLines(self, pointPairs: PyQt6.sip.array[QtCore.QPoint]) -> None: ...
    @typing.overload
    def drawLines(self, pointPair: QtCore.QPoint, *a1: QtCore.QPoint) -> None: ...
    @typing.overload
    ...
    def drawPoints(self, points: PyQt6.sip.array[QtCore.QPointF]) -> None: ...
    @typing.overload
    def drawPoints(self, point: QtCore.QPointF, *a1: QtCore.QPointF) -> None: ...
    @typing.overload
    def drawPoints(self, points: PyQt6.sip.array[QtCore.QPoint]) -> None: ...
    @typing.overload
    def drawPoints(self, point: QtCore.QPoint, *a1: QtCore.QPoint) -> None: ...
    def drawPath(self, path: "QPainterPath") -> None: ...
...
class QTextList(QTextBlockGroup):
    def __init__(self, doc: QTextDocument) -> None: ...
    def setFormat(self, aformat: QTextListFormat) -> None: ...  # type: ignore[override]
...
class QTextTable(QTextFrame):
    ...
    def setFormat(self, aformat: QTextTableFormat) -> None: ...  # type: ignore[override]
...
class QDoubleValidator(QValidator):
    ...
    def fixup(self, input: str) -> None: ...  # type: ignore[override]
