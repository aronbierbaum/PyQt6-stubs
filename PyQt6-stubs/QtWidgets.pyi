...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: str, slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: str, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int]) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, icon: QtGui.QIcon, text: str, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, text: str) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, text: str, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int]) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, text: str, slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> QtGui.QAction: ...
    @typing.overload
    def addAction(self, text: str, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int], slot: PYQT_SLOT, type: QtCore.Qt.ConnectionType = ...) -> QtGui.QAction: ...
    @typing.overload
...
class QFontComboBox(QComboBox):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    def displayFont(self, fontFamily: str) -> typing.Optional[QtGui.QFont]: ...
    def setDisplayFont(self, fontFamily: str, font: QtGui.QFont) -> None: ...
    ...
    def setSampleTextForSystem(self, writingSystem: QtGui.QFontDatabase.WritingSystem, sampleText: str) -> None: ...
    def event(self, e: QtCore.QEvent) -> bool: ...
...
class QGraphicsView(QAbstractScrollArea):
    ...
    def render(self, painter: QtGui.QPainter, target: QtCore.QRectF = ..., source: QtCore.QRect = ..., mode: QtCore.Qt.AspectRatioMode = ...) -> None: ...  # type: ignore[override]
    @typing.overload
...
class QHeaderView(QAbstractItemView):
    ...
    def isIndexHidden(self, index: QtCore.QModelIndex) -> bool: ...
    def indexAt(self, p: QtCore.QPoint) -> QtCore.QModelIndex: ...
    def scrollTo(self, index: QtCore.QModelIndex, hint: QAbstractItemView.ScrollHint) -> None: ...  # type: ignore[override]
    def visualRect(self, index: QtCore.QModelIndex) -> QtCore.QRect: ...
    def rowsInserted(self, parent: QtCore.QModelIndex, start: int, end: int) -> None: ...
    def dataChanged(self, topLeft: QtCore.QModelIndex, bottomRight: QtCore.QModelIndex, roles: typing.Iterable[int] = ...) -> None: ...
    def scrollContentsBy(self, dx: int, dy: int) -> None: ...
...
class QMenu(QWidget):
    ...
    def __init__(self, title: str, parent: typing.Optional[QWidget] = ...) -> None: ...
    @staticmethod
    def menuInAction(action: QtGui.QAction) -> "QMenu": ...
    @typing.overload
...
class QProxyStyle(QCommonStyle):
    ...
    def standardPalette(self) -> QtGui.QPalette: ...
    def generatedIconPixmap(self, iconMode: QtGui.QIcon.Mode, pixmap: QtGui.QPixmap, opt: "QStyleOption") -> QtGui.QPixmap: ...
    def standardPixmap(self, standardPixmap: QStyle.StandardPixmap, opt: "QStyleOption", widget: typing.Optional[QWidget] = ...) -> QtGui.QPixmap: ...  # type: ignore[override]
    def standardIcon(self, standardIcon: QStyle.StandardPixmap, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> QtGui.QIcon: ...
    def layoutSpacing(self, control1: "QSizePolicy.ControlType", control2: "QSizePolicy.ControlType", orientation: QtCore.Qt.Orientation, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    def pixelMetric(self, metric: QStyle.PixelMetric, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    ...
    def itemPixmapRect(self, r: QtCore.QRect, flags: int, pixmap: QtGui.QPixmap) -> QtCore.QRect: ...
    def itemTextRect(self, fm: QtGui.QFontMetrics, r: QtCore.QRect, flags: int, enabled: bool, text: str) -> QtCore.QRect: ...
    def subControlRect(self, cc: QStyle.ComplexControl, opt: "QStyleOptionComplex", sc: QStyle.SubControl, widget: QWidget) -> QtCore.QRect: ...  # type: ignore[override]
    def subElementRect(self, element: QStyle.SubElement, option: "QStyleOption", widget: QWidget) -> QtCore.QRect: ...  # type: ignore[override]
    def sizeFromContents(self, type: QStyle.ContentsType, option: "QStyleOption", size: QtCore.QSize, widget: QWidget) -> QtCore.QSize: ...  # type: ignore[override]
    def drawItemPixmap(self, painter: QtGui.QPainter, rect: QtCore.QRect, alignment: int, pixmap: QtGui.QPixmap) -> None: ...
...
class QSplashScreen(QWidget):
    ...
    def repaint(self) -> None: ...  # type: ignore[override]
...
class QTableWidget(QTableView):
    ...
    def isPersistentEditorOpen(self, item: QTableWidgetItem) -> bool: ...  # type: ignore[override]
    def dropEvent(self, event: QtGui.QDropEvent) -> None: ...
    def event(self, e: QtCore.QEvent) -> bool: ...
