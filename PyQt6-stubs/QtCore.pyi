...
class QObject(PyQt6.sip.wrapper):
    ...
    def setObjectName(self, name: typing.Union["QByteArray", str]) -> None: ...
...
class QAbstractEventDispatcher(QObject):
    ...
    def filterNativeEvent(self, eventType: typing.Union["QByteArray", bytes, bytearray], message: PyQt6.sip.voidptr) -> typing.Tuple[bool, PyQt6.sip.voidptr]: ...
...
class QAbstractNativeEventFilter(PyQt6.sip.simplewrapper):
    def __init__(self) -> None: ...
    def nativeEventFilter(self, eventType: typing.Union["QByteArray", bytes, bytearray], message: PyQt6.sip.voidptr) -> typing.Tuple[bool, PyQt6.sip.voidptr]: ...
...
class QBuffer(QIODevice):
    ...
    @typing.overload
    def setData(self, adata: PyQt6.sip.array[bytes]) -> None: ...
...
class QByteArray(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromBase64Encoding(base64: typing.Union["QByteArray", bytes, bytearray], options: "QByteArray.Base64Option" = ...) -> "QByteArray.FromBase64Result": ...
...
class QCalendar(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, name: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
...
class QSettings(QObject):
    ...
    def contains(self, key: typing.Union[QByteArray, str]) -> bool: ...
    def remove(self, key: typing.Union[QByteArray, str]) -> None: ...
    def value(self, key: typing.Union[QByteArray, str], defaultValue: typing.Any = ..., type: type = ...) -> typing.Any: ...
    def setValue(self, key: typing.Union[QByteArray, str], value: typing.Any) -> None: ...
    def isWritable(self) -> bool: ...
    ...
    def beginWriteArray(self, prefix: typing.Union[QByteArray, str], size: int = ...) -> None: ...
    def beginReadArray(self, prefix: typing.Union[QByteArray, str]) -> int: ...
    def group(self) -> str: ...
    def endGroup(self) -> None: ...
    def beginGroup(self, prefix: typing.Union[QByteArray, str]) -> None: ...
...
class QTimeZone(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, zoneId: typing.Union[QByteArray, bytes, bytearray], offsetSeconds: int, name: str, abbreviation: str, territory: QLocale.Country = ..., comment: str = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(windowsId: typing.Union[QByteArray, bytes, bytearray], territory: QLocale.Country) -> QByteArray: ...
    @staticmethod
...
class QTranslator(QObject):
    ...
    def loadFromData(self, data: PyQt6.sip.array[bytes], directory: str = ...) -> bool: ...
    @typing.overload
...
class QUrl(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromAce(domain: typing.Union[QByteArray, bytes, bytearray], options: "QUrl.AceProcessingOption" = ...) -> str: ...
    def errorString(self) -> str: ...
...
class QUuid(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[QByteArray, str, bytes, bytearray]) -> None: ...
    @typing.overload
    def __init__(self, a0: "QUuid") -> None: ...
    def __le__(self, rhs: "QUuid") -> bool: ...
    def __ge__(self, rhs: "QUuid") -> bool: ...
    @staticmethod
    def fromString(string: typing.Union[QByteArray, str]) -> "QUuid": ...
    @staticmethod
...
class QVersionNumber(PyQt6.sip.simplewrapper):
    ...
    def __hash__(self) -> int: ...
    @staticmethod
    def fromString(string: typing.Union[QByteArray, str]) -> typing.Tuple["QVersionNumber", int]: ...
    def toString(self) -> str: ...
    @staticmethod
